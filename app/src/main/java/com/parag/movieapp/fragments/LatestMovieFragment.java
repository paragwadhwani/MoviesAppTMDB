 ...
 * Use the {@link LatestMovieFragment#newInstance} factory method to
...
public class LatestMovieFragment extends Fragment {
     ...
     * @return A new instance of fragment LatestMovieFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LatestMovieFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recycleLatest = view.findViewById(R.id.recycle_latest);
        recycleLatest.setLayoutManager(new GridLayoutManager(getContext(), 2));
        adapter = new LatestMoviesAdapter(list);
        recycleLatest.setAdapter(adapter);
        tvEmpty = view.findViewById(R.id.tvEmpty);
        callApi();

        recycleLatest.addOnScrollListener(new RecyclerView.OnScrollListener() {  //parag for pagination
            @Override
    ...
    private void callApi() {
        ...
        loader.show();
        Util.getLatestMovieApi(pageCount, new Util.OnMovieResponse() {
            @Override
            public void onSuccess(LatestMoviesResponse response) {
                ...
                if (response != null && response.getResults() != null && !response.getResults().isEmpty()) {
                    ...
                    if (pageCount == 1) {
                        ...
                        recycleLatest.setVisibility(View.GONE);
                    }
                    isLoading = false;
                }
            }
